...
export const STYLE_PROFILES = {
  ...
  health: { id:'health-routine-v1', references:[53.43,32.90], captionY:1000, accent:'0xFF9EC5', captionBox:false, motion:['push','pull','pan'], preferred:['LIFESTYLE','PRODUCT_HERO','CLOSEUP','INFOGRAPHIC'], closing:1.5 },
};

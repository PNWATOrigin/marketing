...
export function generateScript(product,purposeId) {
 ...
 views:[['이런 상품 찾고 있었어요?',name],['내 취향인지','딱 15초만 확인해요'],[feature,next],['눈여겨볼 포인트',name],['이거 좋아할 친구에게','지금 공유해 주세요']],
 sales:[['사기 전에','이 구성부터 확인하세요'],[name,feature],['내게 필요한 포인트',next],[brand,'상세 구성까지 꼼꼼하게'],['상품 구성과 혜택','지금 확인하세요']],
 brand:[['일상에 들이고 싶은 선택',brand],[name,'내 취향에 가까운 발견'],[feature,next],['다음 선택이 필요한 순간',brand],['기억하세요',brand]],
 };

...
export const CEO_PROFILE = {
  ...
  skin: "#ffdcc4",
  thoughts: [
    "클라이언트가 만족할 결과인지부터 본다.",
    "오늘 컨펌할 건 딱 1개만 남기자.",
    "브랜드 톤에서 벗어났으면 다시 잡는다.",
  ],
};
...
export const DEPARTMENTS = [
  {
    ...
    icon: "🔎",
    task: "업계·경쟁사 트렌드 조사",
    report: "출처를 검증하고 오늘의 인사이트를 정리해요.",
  },
  {
    id: "brand",
    name: "브랜드전략팀",
    ...
    icon: "🧬",
    task: "클라이언트 브랜드 아이덴티티 점검",
    report: "톤앤매너 가이드에서 벗어난 부분을 짚어드려요.",
  },
  {
    id: "strategy1",
    name: "캠페인기획팀",
    short: "campaign.studio",
    icon: "💡",
    task: "오늘의 캠페인 아이디어 10개",
    report: "타겟 적합도 기준으로 TOP 3까지 좁혀요.",
  },
  {
    id: "qa",
    name: "품질검수팀",
  ...
  },
  {
    ...
    short: "design.studio",
    icon: "🖼️",
    task: "카드뉴스·배너·썸네일 디자인",
    report: "필요한 시안만 만들고 CTA로 닫아요.",
  },
  {
    id: "partner",
    name: "클라이언트커뮤니케이션팀",
  ...
  },
  {
    ...
    icon: "📋",
    task: "전사 한줄보고·최종 브리핑",
    report: "모든 팀 상태를 모아 대표가 결정할 것만 남겨드려요.",
  },
] as const;
...
export const STAFF_LIST: StaffEntry[] = [
  ...
  { dept: "research", rank: "member", name: "오태윤", role: "업계 리서처",
    colors: ["#2f2a3d", "#c9b8ff", "#b8f0dd"],
    thoughts: ["경쟁사 신규 캠페인인데 반응 0이면 케이스 아님.", "우리 클라이언트 업종에서 되는 전략인지 체크."] },
  { dept: "research", rank: "member", name: "하은채", role: "동향 조사",
    colors: ["#8a4a3c", "#b8f0dd", "#ff8fc0"],
    thoughts: ["이번 주 업계에서 뭐가 화제였지?", "재포장된 사례는 원문으로 안 쳐요."] },

  // ② 브랜드전략팀
  { dept: "brand", rank: "lead", name: "박보라", role: "브랜드전략 팀장", callsign: "박브리",
    colors: ["#372b4a", "#c9b8ff", "#c9b8ff"],
    thoughts: ["지표 연동 전엔 수치를 지어내지 않아요.", "클라이언트 브랜드 컬러에서 벗어난 각도인지 본다."] },
  { dept: "brand", rank: "member", name: "신재원", role: "채널 지표 분석",
    colors: ["#3c3a4f", "#ffe6f2", "#c9b8ff"],
    thoughts: ["저장률이 도달보다 중요해요.", "30일 흐름부터 그려보자."] },
  { dept: "brand", rank: "member", name: "임다혜", role: "아이덴티티 검증",
    colors: ["#5a3450", "#fff3b0", "#ff8fc0"],
    thoughts: ["클라이언트 가이드에서 금지한 프레임이에요.", "타겟이 흐려지면 다시 잡아요."] },

  // ③ 캠페인기획팀
  { dept: "strategy1", rank: "lead", name: "최아름", role: "캠페인기획 팀장", callsign: "최아이",
    colors: ["#c26e4b", "#ff8fc0", "#fff3b0"],
    thoughts: ["오늘도 정확히 10개, 예외 없어요.", "타겟 적합도 점수부터 채우고 시작.", "각도가 겹치면 프레임을 바꾼다."] },
  { dept: "strategy1", rank: "member", name: "정유진", role: "캠페인 아이디어 발굴",
    colors: ["#7b4a2f", "#b8f0dd", "#ff8fc0"],
    thoughts: ["카피를 좀 더 구체적으로 바꿔볼까.", "오늘 액션 유도 문구가 빠졌다."] },
  { dept: "strategy1", rank: "member", name: "배시현", role: "후킹 카피",
    colors: ["#2c2638", "#fff3b0", "#c9b8ff"],
    thoughts: ["훅 3초 안에 안 걸리면 다시 써요.", "단정형으로 닫자, 권유형 금지."] },

  // ④ 품질검수팀
  { dept: "qa", rank: "lead", name: "윤규아", role: "품질검수 팀장", callsign: "윤큐아",
